...
const Intro = () => {
  return (
    <Fragment>
       <div className="top_author_image w-full flex justify-center mb-[35px]">
        <img
          className="w-[200px] h-[200px] rounded-full object-cover shadow-lg" // Set fixed size, rounded shape
          src="assets/img/slider/image.jpg"
          alt="Profile"
        />
      </div>
      <div className="about_title w-full h-auto clear-both float-left border-solid border-[#DFDFDF] border-b pb-[20px] mb-[30px]">
        <h3 className="text-[22px] font-bold">Mohit Hundlani</h3>
          ...
          <div className="tokyo_tm_info w-full h-auto clear-both float-left">
            <ul className="m-0 list-none">
              ...
              <li className="m-0">
                ...
                <span>Nizampura, Vadodara, Gujarat, India</span>
              </li>
              <li className="m-0">
                <span className="min-w-[100px] float-left mr-[10px] font-bold text-black">
                  Email:
      ...
      <div className="tokyo_tm_button" data-position="left">
        <a href="assets/img/cv/cv.pdf" download>
