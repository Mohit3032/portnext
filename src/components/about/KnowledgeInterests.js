const knowledge = [
  { id: 1, text: "React-js, Next-js" },
  { id: 2, text: "Express, Vue, Wordpress" },
  { id: 3, text: "Tailwind, Sass, css" },
  { id: 4, text: "Typescript, React-native, Angular" },
  { id: 5, text: "Javascript, GSAP, Python" },
];
const interests = [
  ...
  { id: 5, text: "Any Ecommerce Website" },
];
